...
DirectInputKeyCodeTable = {
  ...
  'DIK_K':          (0x25, 0x4B), # K
  'DIK_L':          (0x26, 0x4C), # L
  'DIK_SEMICOLON':  (0x27, 0x0), # ;
  'DIK_APOSTROPHE': (0x28, 0x0), # 
  'DIK_GRAVE':      (0x29, 0x0), # `
  'DIK_LSHIFT':     (0x2A, 0x0), # Shift (Left)
  'DIK_BACKSLASH':  (0x2B, 0x0), # \
  'DIK_Z':          (0x2C, 0x5A), # Z
  'DIK_X':          (0x2D, 0x58), # X
  'DIK_C':          (0x2E, 0x43), # C
  'DIK_V':          (0x2F, 0x56), # V
  ...
  'DIK_MULTIPLY':   (0x37, 0x0), # * (Numpad)
  'DIK_LMENU':      (0x38, 0x0), # Alt (Left)
  'DIK_SPACE':      (0x39, 0x20), # Space
  'DIK_CAPITAL':    (0x3A, 0x0), # Caps Lock
  'DIK_F1':         (0x3B, 0x70), # F1
  'DIK_F2':         (0x3C, 0x71), # F2
  'DIK_F3':         (0x3D, 0x72), # F3
  'DIK_F4':         (0x3E, 0x73), # F4
